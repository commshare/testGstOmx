...
#line 704 "grammar.tab.c" /* yacc.c:339  */
...
#line 763 "grammar.tab.c" /* yacc.c:355  */
};
...
#line 777 "grammar.tab.c" /* yacc.c:358  */
...
#line 822 "./grammar.y" /* yacc.c:1646  */
    { (yyval.c) = (yyvsp[0].c);
						if ((yyval.c)->front) {
						  GstElement *element =
							  gst_element_make_from_uri (GST_URI_SRC, (yyvsp[-1].s), NULL, NULL);
...
#line 843 "./grammar.y" /* yacc.c:1646  */
    { GstElement *element =
							  gst_element_make_from_uri (GST_URI_SINK, (yyvsp[0].s), NULL, NULL);
						/* FIXME: get and parse error properly */
						if (!element) {
						  SET_ERROR (graph->error, GST_PARSE_ERROR_NO_SUCH_ELEMENT,
...
#line 895 "./grammar.y" /* yacc.c:1906  */
