...
#ifdef DISABLE_ORC
void
video_convert_orc_convert_AYUV_ARGB (guint8 * ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
video_convert_orc_convert_AYUV_BGRA (guint8 * ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
video_convert_orc_convert_AYUV_ABGR (guint8 * ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
video_convert_orc_convert_AYUV_RGBA (guint8 * ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
video_convert_orc_convert_I420_BGRA (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
video_convert_orc_convert_I420_BGRA (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  if (!p_inited) {
    ...
    orc_program_set_backup_function (p, _backup_video_convert_orc_convert_I420_BGRA);
      ...
      orc_program_append_2 (p, "subb", 1, ORC_VAR_T1, ORC_VAR_T1, ORC_VAR_C2, ORC_VAR_D1);
      orc_program_append_2 (p, "subb", 0, ORC_VAR_T10, ORC_VAR_T10, ORC_VAR_C2, ORC_VAR_D1);
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_I420 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
video_convert_orc_getline_I420 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_I420);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_YUV9 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n){
  int i;
  orc_union64 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
video_convert_orc_getline_YUV9 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_YUV9);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_YUY2 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union64 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var36;
...
video_convert_orc_getline_YUY2 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_YUY2);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_UYVY (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union64 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var36;
...
video_convert_orc_getline_UYVY (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_UYVY);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_YVYU (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union64 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var36;
...
video_convert_orc_getline_YVYU (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_YVYU);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_Y42B (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n){
  int i;
  orc_union64 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
video_convert_orc_getline_Y42B (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_Y42B);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_Y444 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
video_convert_orc_getline_Y444 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_Y444);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_Y800 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
#if defined(__APPLE__) && __GNUC__ == 4 && __GNUC_MINOR__ == 2 && defined (__i386__) 
...
video_convert_orc_getline_Y800 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_Y800);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_Y16 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  orc_union16 var34;
...
video_convert_orc_getline_Y16 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_Y16);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_BGRA (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var32;
...
video_convert_orc_getline_BGRA (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_BGRA);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_ABGR (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var40;
...
video_convert_orc_getline_ABGR (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_ABGR);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_RGBA (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var40;
...
video_convert_orc_getline_RGBA (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_RGBA);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_NV12 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int n){
  int i;
  orc_union64 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  const orc_union16 * ORC_RESTRICT ptr5;
...
video_convert_orc_getline_NV12 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_NV12);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_NV21 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int n){
  int i;
  orc_union64 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  const orc_union16 * ORC_RESTRICT ptr5;
...
video_convert_orc_getline_NV21 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_NV21);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_getline_A420 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, const guint8 * ORC_RESTRICT s4, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
video_convert_orc_getline_A420 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, const guint8 * ORC_RESTRICT s4, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_getline_A420);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_I420 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_int8 * ORC_RESTRICT ptr1;
  orc_int8 * ORC_RESTRICT ptr2;
...
video_convert_orc_putline_I420 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_I420);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_YUY2 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union64 * ORC_RESTRICT ptr4;
  orc_union64 var37;
...
video_convert_orc_putline_YUY2 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_YUY2);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_YVYU (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union64 * ORC_RESTRICT ptr4;
  orc_union64 var37;
...
video_convert_orc_putline_YVYU (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_YVYU);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_UYVY (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union64 * ORC_RESTRICT ptr4;
  orc_union64 var37;
...
video_convert_orc_putline_UYVY (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_UYVY);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_Y42B (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_int8 * ORC_RESTRICT ptr1;
  orc_int8 * ORC_RESTRICT ptr2;
...
video_convert_orc_putline_Y42B (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_Y42B);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_Y444 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  orc_int8 * ORC_RESTRICT ptr1;
  orc_int8 * ORC_RESTRICT ptr2;
...
video_convert_orc_putline_Y444 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_Y444);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_Y800 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var33;
...
video_convert_orc_putline_Y800 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_Y800);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_Y16 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var34;
...
video_convert_orc_putline_Y16 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_Y16);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_BGRA (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var32;
...
video_convert_orc_putline_BGRA (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_BGRA);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_ABGR (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var40;
...
video_convert_orc_putline_ABGR (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_ABGR);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_RGBA (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var40;
...
video_convert_orc_putline_RGBA (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_RGBA);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_NV12 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_union16 * ORC_RESTRICT ptr1;
  const orc_union64 * ORC_RESTRICT ptr4;
...
video_convert_orc_putline_NV12 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_NV12);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_NV21 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_union16 * ORC_RESTRICT ptr1;
  const orc_union64 * ORC_RESTRICT ptr4;
...
video_convert_orc_putline_NV21 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_NV21);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_convert_orc_putline_A420 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3, guint8 * ORC_RESTRICT d4, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_int8 * ORC_RESTRICT ptr1;
  orc_int8 * ORC_RESTRICT ptr2;
...
video_convert_orc_putline_A420 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3, guint8 * ORC_RESTRICT d4, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_convert_orc_putline_A420);
#else
      p = orc_program_new ();
