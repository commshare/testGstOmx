...
#ifdef DISABLE_ORC
void
video_scale_orc_merge_linear_u8 (orc_uint8 * ORC_RESTRICT d1, const orc_uint8 * ORC_RESTRICT s1, const orc_uint8 * ORC_RESTRICT s2, int p1, int n){
  int i;
...
video_scale_orc_merge_linear_u8 (orc_uint8 * ORC_RESTRICT d1, const orc_uint8 * ORC_RESTRICT s1, const orc_uint8 * ORC_RESTRICT s2, int p1, int n)
{
  ...
  if (!p_inited) {
    ...
    static const orc_uint8 bc[] = {
      ...
      114, 99, 95, 109, 101, 114, 103, 101, 95, 108, 105, 110, 101, 97, 114, 95, 
    ...
    orc_program_set_backup_function (p, _backup_video_scale_orc_merge_linear_u8);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_scale_orc_merge_linear_u16 (orc_uint16 * ORC_RESTRICT d1, const orc_uint16 * ORC_RESTRICT s1, const orc_uint16 * ORC_RESTRICT s2, int p1, int p2, int n){
  int i;
...
video_scale_orc_merge_linear_u16 (orc_uint16 * ORC_RESTRICT d1, const orc_uint16 * ORC_RESTRICT s1, const orc_uint16 * ORC_RESTRICT s2, int p1, int p2, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_scale_orc_merge_linear_u16);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_scale_orc_downsample_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  orc_union16 var34;
...
video_scale_orc_downsample_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    static const orc_uint8 bc[] = {
      ...
      114, 99, 95, 100, 111, 119, 110, 115, 97, 109, 112, 108, 101, 95, 117, 56, 
      11, 1, 1, 12, 2, 2, 20, 1, 20, 1, 199, 32, 33, 4, 39, 0, 
      32, 33, 2, 0, 
    };
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_scale_orc_downsample_u8);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_scale_orc_downsample_u16 (guint16 * ORC_RESTRICT d1, const guint16 * ORC_RESTRICT s1, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
...
video_scale_orc_downsample_u16 (guint16 * ORC_RESTRICT d1, const guint16 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    static const orc_uint8 bc[] = {
      ...
      114, 99, 95, 100, 111, 119, 110, 115, 97, 109, 112, 108, 101, 95, 117, 49, 
      54, 11, 2, 2, 12, 4, 4, 20, 2, 20, 2, 198, 32, 33, 4, 76, 
      0, 32, 33, 2, 0, 
    };
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_scale_orc_downsample_u16);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_scale_orc_downsample_u32 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
...
video_scale_orc_downsample_u32 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    static const orc_uint8 bc[] = {
      1, 9, 30, 118, 105, 100, 101, 111, 95, 115, 99, 97, 108, 101, 95, 111, 
      114, 99, 95, 100, 111, 119, 110, 115, 97, 109, 112, 108, 101, 95, 117, 51, 
      50, 11, 4, 4, 12, 8, 8, 20, 4, 20, 4, 197, 32, 33, 4, 21, 
      2, 39, 0, 32, 33, 2, 0, 
    };
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_scale_orc_downsample_u32);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_scale_orc_downsample_yuyv (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union64 * ORC_RESTRICT ptr4;
  orc_union64 var38;
...
video_scale_orc_downsample_yuyv (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    static const orc_uint8 bc[] = {
      1, 9, 31, 118, 105, 100, 101, 111, 95, 115, 99, 97, 108, 101, 95, 111, 
      114, 99, 95, 100, 111, 119, 110, 115, 97, 109, 112, 108, 101, 95, 121, 117, 
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_scale_orc_downsample_yuyv);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_scale_orc_resample_nearest_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  orc_int8 var32;
...
video_scale_orc_resample_nearest_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n)
{
  ...
  if (!p_inited) {
    ...
    static const orc_uint8 bc[] = {
      ...
      114, 99, 95, 114, 101, 115, 97, 109, 112, 108, 101, 95, 110, 101, 97, 114, 
      101, 115, 116, 95, 117, 56, 11, 1, 1, 12, 1, 1, 16, 4, 16, 4, 
      48, 0, 4, 24, 25, 2, 0, 
    };
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_scale_orc_resample_nearest_u8);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_scale_orc_resample_bilinear_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  orc_int8 var32;
...
video_scale_orc_resample_bilinear_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n)
{
  ...
  if (!p_inited) {
    ...
    static const orc_uint8 bc[] = {
      ...
      114, 99, 95, 114, 101, 115, 97, 109, 112, 108, 101, 95, 98, 105, 108, 105, 
      110, 101, 97, 114, 95, 117, 56, 11, 1, 1, 12, 1, 1, 16, 4, 16, 
      4, 50, 0, 4, 24, 25, 2, 0, 
    };
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_scale_orc_resample_bilinear_u8);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_scale_orc_resample_nearest_u32 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var32;
...
#ifdef DISABLE_ORC
void
video_scale_orc_resample_bilinear_u32 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var32;
...
#ifdef DISABLE_ORC
void
video_scale_orc_resample_merge_bilinear_u32 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int p1, int p2, int p3, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
...
#else
static void
_backup_video_scale_orc_resample_merge_bilinear_u32 (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union32 * ORC_RESTRICT ptr0;
...
video_scale_orc_resample_merge_bilinear_u32 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int p1, int p2, int p3, int n)
{
  ...
  if (!p_inited) {
    ...
    static const orc_uint8 bc[] = {
      ...
      114, 99, 95, 114, 101, 115, 97, 109, 112, 108, 101, 95, 109, 101, 114, 103, 
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_scale_orc_resample_merge_bilinear_u32);
#else
      p = orc_program_new ();
...
#ifdef DISABLE_ORC
void
video_scale_orc_merge_bicubic_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, const guint8 * ORC_RESTRICT s4, int p1, int p2, int p3, int p4, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
video_scale_orc_merge_bicubic_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, const guint8 * ORC_RESTRICT s4, int p1, int p2, int p3, int p4, int n)
{
  ...
  if (!p_inited) {
    ...
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_scale_orc_merge_bicubic_u8);
#else
      p = orc_program_new ();
